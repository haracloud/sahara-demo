//// manually adding LiquidCrystal.h & .cpp (because we need to modify some commands)
...
void LiquidCrystal::pulseEnable(void) {
  ...
  delayMicroseconds(50);    // enable pulse must be >450 ns
  digitalWrite(_enable_pin, LOW);
...
void loop() {
  ...
  // update lcd text with number
  t = millis() / 1000;

  lcd.setCursor(0, 1);

  // Print a message to the LCD.
  lcd.print("hi, andy " + String(t));
